...
1. Scarica il file `aitracer-0.1.0.zip` dalla pagina delle [Release su GitHub](https://github.com/lad-sapienza/ai-tracer/releases).
2. In QGIS: **Plugin → Gestisci e installa plugin → Installa da ZIP**.
3. Seleziona il file scaricato e clicca **Installa plugin**.

Sono richiesti QGIS 4.0 e un Python di sistema ≥ 3.10 (individuato automaticamente; non viene utilizzato il Python interno a QGIS).
