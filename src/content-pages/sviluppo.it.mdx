---
title: "Sviluppo"
description: "I principali progetti di sviluppo software del LAD: Laboratorio di Archeologia Digitale alla Sapienza"
---
...
Basato su [Astro](https://astro.build/), React e MDX, s:CMS offre componenti pronti all'uso per integrare, visualizzare e analizzare dati provenienti da database, file statici o servizi remoti: mappe interattive (MapLibre), tabelle ricercabili, gallerie, e molto altro.  
Il sistema adotta una netta separazione tra codice del framework (`core/`) e contenuti utente (`usr/`), che consente di ricevere aggiornamenti del core senza rischiare di sovrascrivere personalizzazioni o contenuti.  
s:CMS supporta l'integrazione con [Directus](https://directus.io/) per la gestione dei dati, utilizza Astro Content Collections con validazione Zod, e si personalizza tramite Bootstrap 5 e CSS custom properties.  
  ...
  - Tecnologie: Astro, React, MDX, TypeScript, Bootstrap 5, MapLibre
  - Sito demo: [scms.lad-sapienza.it](https://scms.lad-sapienza.it/)
  - Blog: [Rilasciata la versione 6 di s:CMS: da Gatsby ad Astro](../blog/scms-v6-da-gatsby-ad-astro/)
