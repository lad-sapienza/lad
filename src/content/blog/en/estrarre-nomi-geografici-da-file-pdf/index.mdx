...
![geoNamesFromPdf: the single-PDF graphical interface](/blog/it/estrarre-nomi-geografici-da-file-pdf/01-interfaccia-grafica.png)
...
![The Zotero assistant: record list, current article and proposed tags](/blog/it/estrarre-nomi-geografici-da-file-pdf/02-assistente-zotero.png)

![A new candidate with an editable field and a button to adopt an existing tag](/blog/it/estrarre-nomi-geografici-da-file-pdf/03-candidato-modificabile.png)
...
![Warning when the language model is missing: gazetteer-only mode is suggested](/blog/it/estrarre-nomi-geografici-da-file-pdf/04-lingua-senza-modello.png)
...
![Scanned PDF: the button to run OCR with ocrmypdf](/blog/it/estrarre-nomi-geografici-da-file-pdf/05-pdf-scansionato-ocr.png)
