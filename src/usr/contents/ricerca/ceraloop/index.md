...
[👉 🇬🇧 Jump to the English version](#introduction)
...
##  Introduction
**CeraLoop** is an experimental study by LAD – Digital Archaeology Laboratory at Sapienza University – that invites contributions, in a simple and guided way, to building a shared knowledge base on the concepts of “similarity”, “perception”, and “comparison” applied to ceramic materials in archaeology. The study does not aim to challenge the traditional methodology of documentation, analysis, and investigation of ceramic finds; on the contrary, it explores the possibility of introducing algorithmic functions that can _support_ and _complement_ the work of specialists, offering tools for orientation and prioritization. At the same time, the experiment allows us to statistically “measure” and openly discuss the very idea of “similar” in archaeology.

The project is part of a broader research program dedicated to applying _computer vision_ techniques to the documentation and analysis of archaeological materials. At this stage, we do not go into technical details: the goal is to collect evaluations from both sector experts and people without specific experience, to observe how the concept of _similarity_ between ceramic profiles is constructed in practice.
...
If you use CeraLoop in your course or laboratory and want to appear on this page as a participant, send us a message at [julian.bogdani@uniroma1.it](mailto:julian.bogdani@uniroma1.it).

## Supervision and contacts

CeraLoop is a project of LAD Sapienza, under the supervision of [Julian Bogdani](mailto:julian.bogdani@uniroma1.it) and [Lorenzo Cardarelli](mailto:lorenzo.cardarelli@uniroma1.it). We are available for project presentations in various contexts – workshops, lectures, laboratories – and to provide further information to those who wish to participate or integrate the activity into a course.
...
- **Can I delete my account?**  
  Certainly! To delete your account and remove all your data from the system, you need to send an email message to [julian.bogdani@uniroma1.it](mailto:julian.bogdani@uniroma1.it). It is very **important to send the message from the same email address that was registered in the system**.
